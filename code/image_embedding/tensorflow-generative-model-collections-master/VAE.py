...
class VAE(object):
    ...
    def visualize_results(self, epoch):
        ...
        pickle.dump(z_tot, open(check_folder(self.result_dir + '/' + self.model_dir) + '/' + self.model_name + '_epoch%03d' % epoch + '_z_tot.p', 'wb'))
        pickle.dump(id_tot, open(check_folder(self.result_dir + '/' + self.model_dir) + '/' + self.model_name + '_epoch%03d' % epoch + '_id_tot.p', 'wb'))
